        ...
        >
          ...
          <div className="space-y-8">
            <motion.div whileHover={{ scale: 1.03, backgroundColor: "#FF6B6B" }} transition={{ type: "spring", stiffness: 300 }}>
              <ExperienceCard
                title="Full-stack and AI/ML Developer"
                company="VaNI MedTech (Startup)"
                period="June 2025 – Present"
                details={[
                  "Architected, built, and deployed the company's flagship full-stack web application (React, TypeScript, Next.js, FastAPI, Redis), enabling scalable, real-time multi-user usage with Docker and Kubernetes orchestration.",
                  "Optimized backend concurrency and load balancing, reducing latency from 500ms to 120ms, supporting 100+ active users.",
                  "Implemented AWS-based CI/CD pipelines with automated testing and deployment, shortening release cycles from 2 days to 6 hours and cutting production bugs by 76%.",
                  "Integrated AI and data workflows using Model Context Protocol to power LLM-driven features with improved accuracy.",
                  "Collaborated cross-functionally to align system design with product goals, ensuring scalability and 99.9%+ uptime in production."
                ]}
              />
            </motion.div>
            <motion.div whileHover={{ scale: 1.03, backgroundColor: "#FF6B6B" }} transition={{ type: "spring", stiffness: 300 }}>
              <ExperienceCard
                ...
                details={[
                  "Successful deployment of LLama3.2-7b-Instruct resulting in a 12% reduction in latency and 20% reduction in cost for OpenAI API calls.",
